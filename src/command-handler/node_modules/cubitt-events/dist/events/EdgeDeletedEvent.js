...
var EdgeDeletedEvent = (function (_super) {
    ...
    function EdgeDeletedEvent(sourceId, version, timestamp, elementId) {
        _super.call(this, sourceId, version, EventType_1.EventType.EdgeDeleted, timestamp, elementId);
    }
    return EdgeDeletedEvent;
}(DeletedEvent_1.DeletedEvent));
exports.EdgeDeletedEvent = EdgeDeletedEvent;
//# sourceMappingURL=EdgeDeletedEvent.js.map