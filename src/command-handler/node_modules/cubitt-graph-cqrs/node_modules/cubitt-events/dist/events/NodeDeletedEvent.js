...
var NodeDeletedEvent = (function (_super) {
    ...
    function NodeDeletedEvent(sourceId, version, timestamp, elementId) {
        _super.call(this, sourceId, version, EventType_1.EventType.NodeDeleted, timestamp, elementId);
    }
    return NodeDeletedEvent;
}(DeletedEvent_1.DeletedEvent));
exports.NodeDeletedEvent = NodeDeletedEvent;
//# sourceMappingURL=NodeDeletedEvent.js.map