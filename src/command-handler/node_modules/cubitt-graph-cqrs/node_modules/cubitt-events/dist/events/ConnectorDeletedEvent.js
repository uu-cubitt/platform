...
var ConnectorDeletedEvent = (function (_super) {
    ...
    function ConnectorDeletedEvent(sourceId, version, timestamp, elementId) {
        _super.call(this, sourceId, version, EventType_1.EventType.ConnectorDeleted, timestamp, elementId);
    }
    return ConnectorDeletedEvent;
}(DeletedEvent_1.DeletedEvent));
exports.ConnectorDeletedEvent = ConnectorDeletedEvent;
//# sourceMappingURL=ConnectorDeletedEvent.js.map